...
const html = `<!DOCTYPE html><html><head><title>Registry</title><style>body{font-family:sans-serif;background:#1a1a1a;color:#eee;padding:2rem}.grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:1rem}.card{background:#2a2a2a;padding:1.5rem;border-radius:8px;border:1px solid #444}.bridge{border-color:#ff4444;box-shadow: 0 0 10px rgba(255,68,68,0.2)}button{background:#ff4444;color:white;border:none;padding:0.5rem 1rem;border-radius:4px;cursor:pointer;margin-top:1rem}</style></head><body><h1>Tactical Utility Registry</h1><div class="grid">${modules.map(m => `
